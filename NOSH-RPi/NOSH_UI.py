...
'''Cook Button'''
cook_img = Image(source ='cook_button.png',allow_stretch=True,keep_ratio=False,pos=(140,100),opacity=1,width=200,height=290)
cook_button = Button(height=300,width=210,text='COOK',halign='left',valign='bottom',text_size=(50,160),pos=(135,95), on_press=cook_callback, opacity=1,border=(10,10,10,10),background_normal='', background_color=(0, 0,0, 1))
cook_button.add_widget(cook_img)
'''Setup Button'''
setup_img = Image(source ='setup_button.png',allow_stretch=True,keep_ratio=False,pos=(450,100),opacity=1,width=200,height=290)
setup_button = Button(height=300,width=210,text='SETUP',halign='left',valign='bottom',border=(10,10,10,10),text_size=(50,160),pos=(445,95), size_hint =(.8, .6), on_press=setup_callback,opacity=1,background_normal='',background_color=(0, 0,0,1))
...
'''Popup'''
popup = Popup(title_size='30sp',title=popup_title,opacity=0.75,content=Button(font_size='60sp',text='YES',background_color=(1,1,1,1),on_press=popup_callback,size_hint=(1,1)),auto_dismiss=False,pos_hint={'x':0.11, 'y':0.12},size_hint=(.77,.75))
...
setup_page = Button(text=' ',halign='left',valign='bottom',text_size=(150,320),pos_hint={'x':0.25, 'y':0.23 },on_press=home_callback_from_setup,background_normal='',background_color=(0, 0, 0, 0))
setup_page.add_widget(setup_label)

'''After Cook Page'''
home_button = Button(text='HOME',font_size='20sp',pos_hint={'x':0.4, 'y':0 }, size_hint =(.2, .1),background_color=(0,0,0,1),on_press=home_callback)
...
'''Various dishes'''
'''DISH 1'''
cook_img1 = Image(source ='carrot_beans.png',allow_stretch=True,keep_ratio=False,pos=(95,65),opacity=1,width=600,height=350)
cook_page1 = Button(font_size='5sp',text='CARROT BEANS',opacity=1,text_size=(1,1),height=30,width=30,on_press=cook_inside_page_callback,background_normal='',background_color=(0, 0, 0, 1))
cook_page1.add_widget(cook_img1)
'''DISH 2'''
cook_img2 = Image(source ='channa_masala.png',allow_stretch=True,keep_ratio=False,pos=(95,65),opacity=1,width=600,height=350)
cook_page2 = Button(font_size='30sp',text='CHANA MASALA',halign='left',valign='bottom',text_size=(150,320), on_press=cook_inside_page_callback,background_normal='',background_color=(0, 0, 0, 1))
cook_page2.add_widget(cook_img2)
'''DISH 3'''
cook_img3 = Image(source ='bhindi_curry.png',allow_stretch=True,keep_ratio=False,pos=(95,65),opacity=1,width=600,height=350)
cook_page3 = Button(font_size='30sp',text='BHINDI CURRY',halign='left',valign='bottom',text_size=(150,320), on_press=cook_inside_page_callback,background_normal='',background_color=(0, 0, 0, 1))
...
def push_button_callback(channel):
    ...
    elif (page_number==FOOD_PAGE_NUMBER)&(page_number!=MAIN_APP_PAGE_NUMBER)&(popup_status==0)&(final_page_status==0):
