...
'''Cook Button'''
cook_img = Image(source='resources/Cook.png', allow_stretch=True, keep_ratio=False, pos=(140, 100), opacity=1, width=200,
                 height=290)
...
'''Setup Button'''
setup_img = Image(source='resources/Device Setup.png', allow_stretch=True, keep_ratio=False, pos=(450, 100), opacity=1, width=200,
                  height=290)
...
'''Reheat Button'''
reheat_img = Image(source='resources/Reheat.png', allow_stretch=True, keep_ratio=False, pos=(140, 100), opacity=1, width=200,
                 height=290)
reheat_button = Button(height=300, width=210, text='REHEAT', halign='left', valign='bottom', text_size=(50, 160),
                     pos=(135, 95), on_press=cook_callback, opacity=1, border=(10, 10, 10, 10), background_normal='',
                     background_color=(0, 0, 0, 1))
reheat_button.add_widget(reheat_img)

'''Clean Button'''
clean_img = Image(source='resources/Clean.png', allow_stretch=True, keep_ratio=False, pos=(450, 100), opacity=1, width=200,
                  height=290)
clean_button = Button(height=300, width=210, text='CLEAN', halign='left', valign='bottom', border=(10, 10, 10, 10),
                      text_size=(50, 160), pos=(445, 95), size_hint=(.8, .6), on_press=setup_callback, opacity=1,
                      background_normal='', background_color=(0, 0, 0, 1))
clean_button.add_widget(clean_img)

'''Taste Button'''
taste_img = Image(source='resources/Taste Configuration.png', allow_stretch=True, keep_ratio=False, pos=(140, 100), opacity=1, width=200,
                 height=290)
taste_button = Button(height=300, width=210, text='TASTE CONFIGURATION', halign='left', valign='bottom', text_size=(50, 160),
                     pos=(135, 95), on_press=cook_callback, opacity=1, border=(10, 10, 10, 10), background_normal='',
                     background_color=(0, 0, 0, 1))
taste_button.add_widget(taste_img)

'''Power Button'''
power_img = Image(source='resources/Power Off.png', allow_stretch=True, keep_ratio=False, pos=(450, 100), opacity=1, width=200,
                  height=290)
power_button = Button(height=300, width=210, text='POWER OFF', halign='left', valign='bottom', border=(10, 10, 10, 10),
                      text_size=(50, 160), pos=(445, 95), size_hint=(.8, .6), on_press=setup_callback, opacity=1,
                      background_normal='', background_color=(0, 0, 0, 1))
...
'''DISH 5'''
cook_img5 = Image(source='resources/pasta.jpg', allow_stretch=True, keep_ratio=False, pos=(95, 65), opacity=1, width=600,
                  height=350)
