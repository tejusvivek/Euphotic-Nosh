...
'''DISH 2'''
cook_img2 = Image(source='resouces/channa_masala.png', allow_stretch=True, keep_ratio=False, pos=(95, 65), opacity=1, width=600,
                  height=350)
...
'''DISH 5'''
cook_img5 = Image(source='pasta.png', allow_stretch=True, keep_ratio=False, pos=(95, 65), opacity=1, width=600,
                  height=350)
